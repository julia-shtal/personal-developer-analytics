...
- Frontend: StatusBar polls `/actuator/health` for the live/online dot.
...
**Follow-on:** wire a "new message" notification through the T9 dispatch service (gated by a new pref), and consider SSE/WebSocket for true real-time. Leave as `TODO(messaging-realtime):`.
