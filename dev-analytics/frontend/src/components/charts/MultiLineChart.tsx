...
export function MultiLineChart({ data, height = 280, unit = '' }: MultiLineChartProps) {
  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <LineChart data={chartData} margin={{ top: 4, right: 12, left: 0, bottom: 0 }}>
        ...
        <YAxis tick={{ fontSize: 11, fill: '#9ca3af' }} tickLine={false} axisLine={false} unit={unit} width={36} />
