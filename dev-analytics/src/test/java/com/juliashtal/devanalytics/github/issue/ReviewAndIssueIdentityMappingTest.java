...
class ReviewAndIssueIdentityMappingTest {
    ...
    GitHubPullRequestStatsEnrichmentService enrichment;
    ...
    void setUp(WireMockRuntimeInfo wm) {
        ...
        enrichment = new GitHubPullRequestStatsEnrichmentService(prRepository, reviewRepository, new ObjectMapper());
