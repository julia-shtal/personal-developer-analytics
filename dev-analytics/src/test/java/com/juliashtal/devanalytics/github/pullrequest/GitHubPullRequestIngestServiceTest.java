...
@WireMockTest
class GitHubPullRequestIngestServiceTest {
    ...
    GitHubPullRequestIngestService service;
    String wmBaseUrl;
    DataSourceConfig cfg;

    @BeforeEach
    void setUp(WireMockRuntimeInfo wm) {
        service = new GitHubPullRequestIngestService(repoRepository, prRepository, clientFactory, new ObjectMapper());
