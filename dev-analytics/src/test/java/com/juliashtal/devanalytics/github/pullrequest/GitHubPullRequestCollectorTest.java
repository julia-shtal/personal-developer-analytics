...
class GitHubPullRequestCollectorTest {
    ...
    @Mock GitHubPullRequestIngestService ingestService;
    @Mock GitHubPullRequestStatsEnrichmentService enrichmentService;

    @InjectMocks
    GitHubPullRequestCollector collector;
    ...
    void collectForRepository_emptyIngestResult_returnsZero() {
        when(ingestService.collectPullRequests(eq(1L), any()))
                .thenReturn(new GitHubPullRequestIngestService.IngestResult(
