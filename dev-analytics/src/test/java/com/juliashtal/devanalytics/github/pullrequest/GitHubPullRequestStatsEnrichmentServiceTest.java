...
@WireMockTest
class GitHubPullRequestStatsEnrichmentServiceTest {

    @Mock GitHubPullRequestRepository prRepository;
    @Mock GitHubPrReviewRepository reviewRepository;

    GitHubPullRequestStatsEnrichmentService service;
    String wmBaseUrl;
    ...
    void setUp(WireMockRuntimeInfo wm) {
        service = new GitHubPullRequestStatsEnrichmentService(prRepository, reviewRepository, new ObjectMapper());
