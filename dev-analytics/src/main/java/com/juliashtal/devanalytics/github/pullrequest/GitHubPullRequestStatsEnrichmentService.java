...
@Slf4j
public class GitHubPullRequestStatsEnrichmentService {
     ...
     */
    public void refreshReviews(GitHubPullRequestEntity pr, String apiBase, String token, String repoFullName)
